        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              title: Text('Message'),
              subtitle: Text(
                  "Lutyens, although similar in outline, were much more austere and "),
            ),
            Divider(
              thickness: 1,
            ),
            ...
            Text(
                "Lutyens, although similar in outline, were much more austere and Lutyens, although similar in outline, were much more austere and Lutyens, although similar in outline, were much more austere and "),
            Divider(
              thickness: 1,
            ),
            SizedBox(
